...
var successful = exports.successful = function successful(r$$, selector) {
  var requestProp = arguments.length <= 2 || arguments[2] === undefined ? 'request' : arguments[2];
...
var attachSelectorHelper = exports.attachSelectorHelper = function attachSelectorHelper(r$$) {
  ...
  r$$[selectorMethod] = function (property, match) {
    ...
    var makeTestSimple = function makeTestSimple(match) {
      return match instanceof RegExp ? match.test.bind(match) : function (_) {
        return match === _;
      };
    };
  ...
  return function driver(request$) {
    var response$$ = request$.map(function (request) {
      ...
      response$ = responseProp ? response$.map(function (response) {
        ...
        return _ref2 = {}, _defineProperty(_ref2, responseProp, response), _defineProperty(_ref2, requestProp, reqOptions), _ref2;
