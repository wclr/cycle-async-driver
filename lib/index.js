...
exports.createDriver = exports.makeAsyncDriver = exports.attachHelpers = exports.attachSelectorHelper = exports.attachFlattenHelpers = exports.select = exports.failed = exports.successful = exports.proxyAndKeepMethods = exports.isPromise = exports.isObservable = undefined;
...
var makeFlattenHelper = function makeFlattenHelper(flattenFn) {
  return function fn() {
    ...
    var selector = args[0];
    var _args$ = args[1];
    var requestProp = _args$ === undefined ? 'request' : _args$;
...
var attachSelectorHelper = exports.attachSelectorHelper = function attachSelectorHelper(r$$) {
  ...
  var selectorMethod = _ref2$selectorMethod === undefined ? 'select' : _ref2$selectorMethod;
  var selectorProp = _ref2.selectorProp;
