...
exports.createDriver = exports.makeAsyncDriver = exports.proxyAndKeepMethods = exports.attachHelpers = exports.attachSelectorHelper = exports.attachFlattenHelpers = exports.select = exports.failed = exports.successful = exports.isPromise = exports.isObservable = undefined;
...
var defaultFlattenHelpers = ['successful', 'failed'];

var flattenSuccessful = function flattenSuccessful(r$, selector, requestProp) {
  return (selector ? r$.map(function (r) {
    return selector(r, r$[requestProp]);
  }) : r$).catch(_rx.Observable.empty());
};

var flattenFailed = function flattenFailed(r$, selector, requestProp) {
...
var successful = exports.successful = makeFlattenHelper(flattenSuccessful);
var failed = exports.failed = makeFlattenHelper(flattenFailed);
...
var attachHelpers = exports.attachHelpers = function attachHelpers(r$$) {
  ...
  var selector = _options$selector === undefined ? true : _options$selector;
  ...
  if (selector) {
    attachSelectorHelper(r$$, _extends({}, selector, {
      requestProp: requestProp
    }));
  }

  if (keepMethods) {
    var methodsToKeep = ['isolateSink', 'isolateSource'].concat(selector ? selector.selectorMethod || defaultSelectorMethod : []).concat(flatten || []);
