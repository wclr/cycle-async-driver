...
exports.createDriver = exports.makeAsyncDriver = exports.proxyAndKeepMethods = exports.attachHelpers = exports.attachSelectorHelper = exports.attachFlattenHelpers = exports.select = exports.failure = exports.success = undefined;
...
var attachHelpers = exports.attachHelpers = function attachHelpers(r$$) {
  ...
  var _options$forceAttachi = options.forceAttaching;
  var forceAttaching = _options$forceAttachi === undefined ? false : _options$forceAttachi;
  ...
  if (keepMethods) {
    var methodsToKeep = ['isolateSink', 'isolateSource'].concat(selectorMethod || []).concat(flatten || []).concat(pullHelper || []).concat(keepMethods);
